...
SEXP _exonBlocks_classify_reads(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_exonBlocks_classify_reads", (DL_FUNC)&_exonBlocks_classify_reads, 13},
    {NULL, NULL, 0}};
